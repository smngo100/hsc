...
export const translations = {
  en: {
    ...
    footer: {
      ...
      joinUsBtn: 'JOIN US',
      donateBtn: 'DONATE',
      copyright: '©2026 HSC - HISPANICS SERVICE CENTER NONPROFIT. All Rights Reserved.',
    ...
    services: {
      ...
      rides: {
        ...
        callNote: 'For more information or to schedule a ride, call (012) 345-6789.',
      },
      shelter: {
        ...
        callNote: 'To check eligibility or to join the waitlist, call (012) 345-6789.',
      },
      pantry: {
        title: 'Food Pantry',
        shortDesc:
    ...
    gallery: {
      ...
      items: {
        ...
        2: { title: 'Food Pantry Stocking', subtitle: 'Weekly Food Pantry Support' },
  ...
  es: {
    ...
    footer: {
      ...
      joinUsBtn: 'ÚNETE',
      donateBtn: 'DONAR',
      copyright: '©2026 HSC - CENTRO DE SERVICIOS HISPANOS. Todos los derechos reservados.',
    ...
    services: {
      ...
      rides: {
        ...
        body:
          'Para muchos, el transporte es la barrera invisible entre la estabilidad y las dificultades. Una cita médica perdida, un trabajo perdido o un programa de trabajo que se pierde pueden ser trágicos. Este programa ayuda a aliviar esa carga.',
        ...
        callNote: 'Para obtener más información o programar un viaje, llame al (012) 345-6789.',
      },
      shelter: {
        ...
        body:
          'El Centro de Servicios Hispanos brinda refugio de emergencia temporal a familias que necesitan un lugar seguro durante períodos de dificultad. Las familias pueden quedarse por una corta duración mientras trabajan para conseguir una vivienda permanente.',
        list: [
        ...
        callNote: 'Para verificar la elegibilidad o unirse a la lista de espera, llame al (012) 345-6789.',
      },
      pantry: {
      ...
      senior: {
        ...
        body:
          'Financiado por Valley Area Agency on Aging, nuestro programa brinda servicios esenciales que promueven la dignidad y la independencia de las personas mayores y sus cuidadores en nuestra comunidad, ayudándoles a permanecer seguros y acompañados en sus hogares.',
      ...
      translation: {
        ...
        body:
          'Brindamos asistencia de traducción bilingüe para ayudar a los residentes a realizar sus trámites diarios.',
        categories: {
    ...
    gallery: {
      ...
      items: {
        1: { title: 'Reunión Comunitaria', subtitle: 'Asamblea Comunitaria de HSC' },
        2: { title: 'Abastecimiento de Despensa', subtitle: 'Apoyo Semanal de Despensa' },
        3: { title: 'Camioneta de Transporte', subtitle: 'Flota de Vehículos de Tránsito' },
        4: { title: 'Instalaciones del Refugio', subtitle: 'Instalaciones de Vivienda' },
        5: { title: 'Actividad Social para Adultos Mayores', subtitle: 'Hora Social Semanal' },
        6: { title: 'Estación de Alimentos para Llevar', subtitle: 'Distribución al Aire Libre' },
      },
    },
    about: {
      ...
      p1:
        'Fundado en 1972 como el Centro de Información de Habla Hispana, un grupo de miembros dedicados de la comunidad se unió para brindar servicios lingüísticos y sociales a trabajadores migrantes y familias hispanas que se establecían en el condado de Lapeer. La organización se incorporó en 1989 como el Centro de Servicios Hispanos y amplió su misión en 1999 como organización sin fines de lucro para atender a TODOS los residentes del condado de Lapeer, sin importar sus antecedentes.',
      p2:
        'En 1997, HSC se asoció con Bethany Mennonite Church para abrir un refugio familiar en Imlay City. Lo que comenzó con 4 camas creció para albergar hasta 20 personas, brindando a las familias en crisis un lugar seguro y digno donde quedarse hasta 90 días mientras se recuperan.',
      p3:
        'Hoy, casi 50 años después, HSC es un recurso comunitario de confianza que se asocia con agencias locales para atender a cualquier persona que enfrente dificultades. En 2018, HSC lanzó Imlay City Area Rides para cubrir una importante brecha de transporte en el condado. Es un símbolo de lo que sucede cuando una comunidad se cuida mutuamente con compasión, perseverancia y equidad.',
