...
export const SERVICES_DATA: ServiceItem[] = [
  {
    ...
    shortDesc: 'Free transportation connecting rural residents to medical, legal, and essential appointments.',
    iconType: 'rides',
  },
  {
    id: 'shelter',
    title: 'Family Shelter',
    shortDesc: 'Safe, non-violent temporary housing for women and children who need shelter from crisis.',
    iconType: 'shelter',
  },
  {
    id: 'pantry',
    title: 'Food Pantry',
    shortDesc: 'Free, dignified access to nutritious food. Our pantry is open to all Lapeer County residents.',
    iconType: 'pantry',
  },
  {
    id: 'senior',
    title: 'Senior Program',
    shortDesc: 'In-home support, transportation, and twice-weekly social activities for seniors.',
    iconType: 'senior',
  },
  {
    id: 'translation',
    title: 'Translation Services',
    shortDesc: 'Bilingual translation and document assistance for forms, certificates, and legal paperwork.',
